...
from Python.hrnet_implementation.misc.visualization import draw_points, draw_skeleton, draw_points_and_skeleton, joints_dict, check_video_rotation
...
if __name__ == '__main__':
    ...
    parser.add_argument("--filename", "-f", help="open the specified video (overrides the --camera_id option)",
                        type=str, default='Python/hrnet_implementation/video_cut.mp4')
    ...
    parser.add_argument("--hrnet_weights", "-w", help="hrnet parameters - path to the pretrained weights",
                        type=str, default="Python/hrnet_implementation/pose_hrnet_w48_384x288.pth")
