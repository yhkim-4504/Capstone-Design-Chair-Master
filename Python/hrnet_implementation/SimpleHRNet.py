...
from Python.hrnet_implementation.models.hrnet import HRNet
from Python.hrnet_implementation.models.poseresnet import PoseResNet
...
class SimpleHRNet:
    ...
    def __init__(self,
        ...
        if self.multiperson:
            from Python.hrnet_implementation.models.detectors.YOLOv3 import YOLOv3
